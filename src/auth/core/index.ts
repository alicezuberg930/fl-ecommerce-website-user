import { generateStateOrCode } from '@/utils/crypto'
            ...
            GET: async (request: Request) => {
                ...
                try {
                    ...
                    if (callbackMatch) {
                        ...
                        const session = await fetch(`${process.env.BASE_API}${PATH_API.auth.login}`, {
                            method: "POST",
            ...
            POST: async (request: Request) => {
                ...
                try {
                    ...
                    if (pathname === '/api/auth/sign-up') {
                        ...
                        const response = await fetch(`${process.env.BASE_API}${PATH_API.auth.register}`, {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
