...
interface Props extends CardProps {
  ...
  onApplyPaymentMethod: (paymentMethod: string) => void;
}

export default function CheckoutPaymentMethods({ paymentOptions, cardOptions, onApplyPaymentMethod, ...other }: Props) {
